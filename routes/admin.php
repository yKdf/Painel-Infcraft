...
Route::group(['prefix' => 'settings'], function () {
    ...
    Route::get('/google', [Admin\Settings\GoogleController::class, 'index'])->name('admin.settings.google');
    ...
    Route::patch('/google', [Admin\Settings\GoogleController::class, 'update']);
