    ...
    const connect = (uuid: string) => {
        ...
        socket.on('jwt error', (error: string) => {
            ...
            if (reconnectErrors.find((v) => error.toLowerCase().indexOf(v) >= 0)) {
                ...
                setError('Ocorreu um erro ao validar as credenciais fornecidas para o websocket. Atualize a página.');
            }
        });
                    ...
                    {error === 'connecting' ? (
                        <>
                            ...
                            <p css={tw`ml-2 text-sm text-red-100`}>
                                Estamos tendo problemas para se conectar ao seu servidor, aguarde...
                            </p>
                        </>
                    ) : (
