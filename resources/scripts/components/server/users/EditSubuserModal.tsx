                ...
                {!isRootAdmin && loggedInPermissions[0] !== '*' && (
                    <div css={tw`mt-4 pl-4 py-2 border-l-4 border-cyan-400`}>
                        <p css={tw`text-sm text-neutral-300`}>
                            Somente as permissões atribuídas à sua conta no momento podem ser selecionadas ao criar ou
                ...
                {!subuser && (
                    <div css={tw`mt-6`}>
                        <Field
                            ...
                            description={
                                'Digite o endereço de e-mail do usuário que você deseja convidar como subusuário deste servidor.'
                            }
                        />
                    </div>
                )}
