    ...
    return (
        <Formik
            ...
            validationSchema={object().shape({
                term: string().min(3, 'Insira pelo menos três caracteres para iniciar a pesquisa.'),
            })}
            ...
            {({ isSubmitting }) => (
                <Modal {...props}>
                    <Form>
                        <FormikFieldWrapper
                            name={'term'}
                            label={'Pesquisa de Server'}
                            description={'Insira um nome de servidor, uuid ou alocação para iniciar a pesquisa.'}
                        >
                            <SearchWatcher />
