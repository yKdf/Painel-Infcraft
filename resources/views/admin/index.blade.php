...
<div class="row">
    <div class="col-xs-12">
        ...
        ">
            ...
            <div class="box-body">
                The official version of Pterodactyl Panel is <a href="https://github.com/Pterodactyl/Panel/releases/v{{ $version->getPanelPtero() }}" target="_blank"><code>Pterodactyl {{ $version->getPanelPtero() }}</code></a>.
            </div>
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="col-xs-6 col-sm-3 text-center">
        <a href="https://infcraft.net"><button class="btn btn-primary" style="width:100%;"><i class="fa fa-fw fa-link"></i> Site</button></a>
    </div>
    <div class="clearfix visible-xs-block">&nbsp;</div>
    <div class="col-xs-6 col-sm-3 text-center">
        <a href="https://github.com/yKdf/Painel-Infcraft"><button class="btn btn-primary" style="width:100%;"><i class="fa fa-fw fa-support"></i> Github</button></a>
    </div>
    <div class="col-xs-6 col-sm-3 text-center">
