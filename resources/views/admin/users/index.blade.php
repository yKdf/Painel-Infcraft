                            ...
                            <tr class="align-middle">
                                ...
                                <td class="text-center">
                                    @if(!empty($user->google_id))
                                        <i class="fa fa-check text-green" data-toggle="tooltip" data-placement="top" title="Linked{{ !empty($user->google_email) ? ': ' . $user->google_email : '' }}"></i>
                                    @else
                                        <i class="fa fa-times text-red" data-toggle="tooltip" data-placement="top" title="Not linked"></i>
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($user->use_totp)
